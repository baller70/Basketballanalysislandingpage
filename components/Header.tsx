          ...
          <div className="section-content">
            <nav className="flex items-center justify-between h-16 md:h-20">
              ...
              <div className="hidden md:flex items-center gap-3">
                <Button variant="ghost" className="text-white hover:bg-white/10 uppercase tracking-wide">
                  Log In
                </Button>
                <Button variant="glow" className="group uppercase tracking-wide">
                ...
                <div className="section-content py-6">
                  <div className="flex flex-col gap-4">
                    ...
                    <div className="flex flex-col gap-3 pt-4 border-t border-border/50">
                      <Button variant="ghost" className="w-full justify-center text-white hover:bg-white/10 uppercase tracking-wide">
                        Log In
                      </Button>
                      <Button variant="glow" className="w-full justify-center uppercase tracking-wide">
