...
// Local shooting form images - all 86 unique NBA/WNBA player shots
const basketballImages = [
  '/shooting/00000169-0cf1-dbbe-a16f-4ef1b11b0000.webp',
  '/shooting/0420e54d1faf0452fdf19eb4bab3cd76 (1).jpg',
  '/shooting/0caf26f6ee754936bdb63682973aee51.webp',
  '/shooting/0f25fb3e030f11d61e0351d753d57a4b7f4abef8158e7d333a4afee74e7c6967 copy.jpg',
  '/shooting/0f25fb3e030f11d61e0351d753d57a4b7f4abef8158e7d333a4afee74e7c6967.webp',
  '/shooting/1_PumjpmIbXp8nSPnGMCrf9w.jpg',
  '/shooting/10-best-shooting-forms-in-nba-history (2).jpg',
  ...
  '/shooting/16472352488335 copy.jpg',
  '/shooting/16479881724525.jpg',
  '/shooting/167-1678251_kyle-korver-wallpaper-20-kyle-korver-shooting-form.jpg',
  '/shooting/1920x0.jpg',
  '/shooting/20200201_ely_0854 copy.jpg',
  '/shooting/2023-OKC-GS-Klay copy.jpg',
  '/shooting/2023-OKC-GS-Klay.webp',
  '/shooting/2cb5f15c048b1e2c759f9c6ab86e60b3035bd91ea76a4f5dd2b13dd1f9d519ab copy.jpg',
  ...
  '/shooting/621d518377b53.hires copy.jpg',
  ...
  '/shooting/allan-houston-nathaniel-s-butler (1).jpg',
  ...
  '/shooting/Beller-DamianLillardShot copy.jpg',
  '/shooting/BN-GP418_count0_M_20150125142358.jpg',
  '/shooting/BNG-L-WARRIORS-1211-4 copy.jpg',
  ...
  '/shooting/GettyImages-1243660668-scaled (1).jpg',
  ...
  '/shooting/hi-res-d92b6dc2e02c2456b4a8944aa8cb4003_crop_north copy.jpg',
  ...
  '/shooting/kevin-durant-phoenix-suns-unsigned-shooting-vs-clippers-in-2023-nba-playoffs-photograph_ss5_p-200125183+u-8vdlmneizhqzo2hwbrfh+v-33wtyzmaltr5v1vbevem copy.jpg',
  ...
  '/shooting/new-york-knicks-guard-donte-75691668 copy.jpg',
  ...
  '/shooting/SPORTS_160219815_AR_0_ATXBUNLLEWEY (1).webp',
  ...
  '/shooting/TAVCl3JXtkp9Kqw8U6_hDBaEtXCnZYc1SebnzekiK7Z6PCx0CTo5rdoWE2MKGfGeNbU9ElLZP8-HxxkMFZOb-g copy.jpg',
  '/shooting/the+greatest+NBA+shooters+of+all-time copy.jpg',
  '/shooting/tumblr_inline_og4wcrQWEQ1up8ogc_1280.jpg',
  '/shooting/tyler-herro.jpg',
  '/shooting/usatsi_21919476.jpg',
  '/shooting/valiers_at_golden_sta_100282738-e1528400698633 copy.jpg',
  '/shooting/w640xh480_REU_2019849.jpg',
  '/shooting/wp12199434.webp',
]

// Generate rows of images (10 rows, 25 images each - exact PhotoAI structure)
const generateRows = () => {
  const rows = []
  for (let i = 0; i < 10; i++) {
    const rowImages = []
...
export default function BackgroundGrid() {
  return (
    <>
      {/* Inject the CSS styles - Exact PhotoAI.com Netflix-style */}
      <style jsx global>{`
        .netflix-container {
          top: 0;
          left: 0;
      ...
      {/* Netflix-style background container - exact PhotoAI.com structure */}
              ...
              <div key={rowIndex} className="netflix-box">
                {row.map((imgSrc, imgIndex) => (
                  <div
                    ...
                    style={{ 
                      backgroundImage: `url("${imgSrc.replace(/\(/g, '%28').replace(/\)/g, '%29').replace(/\s/g, '%20').replace(/\+/g, '%2B')}")` 
                    }}
                  />
                ))}
              </div>
